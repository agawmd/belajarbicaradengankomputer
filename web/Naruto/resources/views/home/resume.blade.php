...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="box-two">
            <div class="box-text">
                ...
                <hr>
                <div class="text-title">Education</div>
                <hr>
                <div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="third" style="padding-left: 20px;">
            ...
            <p>
                INSTITUT KARATE-DO NASIONAL SULAWESI SELATAN 2006 - 2013
            </p>
            <p>
                TAMAN PENDIDIKAN AL-QUR'AN NURUL QAMAR 2007
            </p>
            <p>
                GERAKAN ANTI NARKOBA SE-SULAWESI SELATAN 2009
            </p>
            <p>
            ...
            <div>
                "THE POWER OF MIND SEMINAR" STMIK KHARISMA MAKASSAR 2016
            </div>
            <p>
                K-ART STMIK KHARISMA MAKASSAR 2016
            </p>
            <p>
