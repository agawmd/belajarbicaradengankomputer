...
public class login_admin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            sql = "SELECT * FROM tb_admin WHERE username = '"+jTextField1.getText()+"'AND password = '"+jPasswordField1.getSelectedText()+"'";
            rs = stat.executeQuery(sql);
            if (rs.next()) {
                if (jTextField1.getText().equals(rs.getString("username")) && jPasswordField1.getSelectedText().equals(rs.getString("password"))) {
